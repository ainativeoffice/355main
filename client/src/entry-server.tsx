...
const routeJsonLd: Record<string, object[]> = {
  ...
  "/shells": [
    shellListing(
      ...
      814,
      1065,
      "Executive Sovereign Shell on Floor 1 of 355 Main, Armonk — 814 USF / 1,065 RSF of Class A space fused with on-premises, deterministic AI, outfitted with Vitra. Available for a single institution.",
    ),
    shellListing(
      "Shell B",
      "Suite B",
      888,
      1162,
      "The largest executive Sovereign Shell on Floor 1 of 355 Main, Armonk — 888 USF / 1,162 RSF of Class A space fused with on-premises, deterministic AI, outfitted with Vitra. Available for a single institution.",
    ),
  ],
  "/thesis": [],
  "/about": [
