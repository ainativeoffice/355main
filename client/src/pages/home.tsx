...
const spacePhotos = [
  ...
  { src: spaceKitchenIsland, alt: "Cafe with dark tile backsplash and kitchen island", label: "Cafe" },
  { src: spacePantry, alt: "Break room with built-in cabinetry and tile accent wall", label: "Break Room" },
